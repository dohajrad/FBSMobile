...
--
-- Host: 127.0.0.1:3307
-- Generation Time: May 13, 2025 at 04:55 PM
...
(17, 'Jrad', 'Doha', 'a', 'FFE9AAEAA2A2D5048174DF0B80599EF0197EC024C4B051BC9860CFF58EF7F9F3', '01.02.03.04.05', 1);
...
--
-- Table structure for table `prestationabonnement`
--
...
--
-- Dumping data for table `prestationabonnement`
--
...
(3, 1, 'CRF', 'Mercredi', '18:00:00', 10),
(4, 2, 'ZUM', 'Jeudi', '17:00:00', 20),
...
--
-- Stand-in structure for view `v_abopresta`
...
--
-- Stand-in structure for view `v_seance`
-- (See below for the actual view)
--
...
--
-- Structure for view `v_abopresta`
--
...
--
-- Constraints for table `prestationabonnement`
--
